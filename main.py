...
from util import (suits, values, number_of_decks, build_deck, card_tens, card_ace, calculate_score, turn_has_blackjack,
...
while game_is_on:
    ...
    while current_match_is_on:
        ...
        # if play again check if deck has enough cards, if not create a new deck ad re-shuffle
